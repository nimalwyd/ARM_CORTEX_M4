...
/*
  ...
  *DESCRIPTION    :  This project is  for using Systick timer to get specific delays.LEDs are blinked in different delays using single 
					 Systick handler
 ...
 *
 * DESCRIPTION 	: This funcion handles Systick timer callback and This function is called upon every time the timerinterrupt is generated
 *
